...
// - За допомогою циклу while виHelloвести в документ 20 блоків h1 c довільним текстом всередині.
...
//     document.write(`<li>${listOfItemsKey} - ${listOfItems[listOfItemsKey]}</li>`);
// }
// document.write('</ul>');
